...
import static backpack.Indexer.DF;
import static backpack.Indexer.TFIDF;
import static backpack.Crawler.Data;
...
public class QueryProcessor {
    ...
    public static void query() {
        ...
        calculateCosineSimilarity(TFIDF, query_norm, threshold);

        query();
    }

    public static void calculateCosineSimilarity(ArrayList<Double> QueryVector, double query_norm, int threshold) {
